...
#ifndef GPUEXERCISE_H
#define GPUEXERCISE_H
...
{
public:
	GpuExercise(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList);
	GpuExercise(const GpuExercise& rhs) = delete;
	GpuExercise& operator=(const GpuExercise& rhs) = delete;
	~GpuExercise() = default;
