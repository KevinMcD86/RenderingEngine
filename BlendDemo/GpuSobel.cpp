//***************************************************************************************
// GpuSobel.cpp by Frank Luna (C) 2011 All Rights Reserved.
//***************************************************************************************
...
GpuSobel::GpuSobel(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList)
{
	md3dDevice = device;
...
void GpuSobel::BuildResources(ID3D12GraphicsCommandList* cmdList)
{
...
void GpuSobel::BuildRootSignature()
{
...
void GpuSobel::CopyRunResultsToCPU(ID3D12GraphicsCommandList* cmdList)
{
...
void GpuSobel::OutputResultsToFile()
{
